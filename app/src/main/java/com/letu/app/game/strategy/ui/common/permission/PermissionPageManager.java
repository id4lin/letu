package com.letu.app.game.strategy.ui.common.permission;
...
public class PermissionPageManager {
    ...
    //自己的项目包名
    private String packageName="com.letu.app.game.strategy";
//
...
//    }
    ...
    public enum Singleton {
        INSTANCE;
        private PermissionPageManager instance;

        private Singleton() {
            instance = new PermissionPageManager();
        }

        public PermissionPageManager getInstance() {
            return instance;
        }
    }

    public static PermissionPageManager getInstance() {
        return PermissionPageManager.Singleton.INSTANCE.getInstance();
    }
